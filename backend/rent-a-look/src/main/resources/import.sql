INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Top Pekin', 'Tejido de punto apto para agua.\n-Color crema\n-Tela dry fit\n-Tela con protección UV.', 'Vestimenta', 22123, 1000, 'M', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Latina', 'Vestido corto en tejido de punto, con escote en espalda y corte en laterales frontales.\n-Color gris oscuro\n-Tejido de lúrex', 'Vestimenta', 22234, 800, 'S', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Falda Ibiza', 'Falda de tejido de punto elastizado, tiro medio, con detalle de hebilla\n-Color negro\n-Queda por debajo de la cadera\n-Tejido de lúrex\n*El top no está incluido', 'Vestimenta', 22345, 1500, 'L', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Falda Volados','Falda de tejido de punto elastizado, tiro medio, con volados\n-Color gold\n-Tejido de lúrex', 'Vestimenta', 22456, 1200, 'M', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Ola', 'Vestido tejido corto, con aberturas a lo largo de los brazos y en el escote, ideal y cómodo tanto para fiestas a la noche o civiles.\n-Color negro\n-Tejido de lúrex\n-Color negro', 'Vestimenta', 22567, 1800, 'L', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Denver','Vestido corto confeccionado en lentejuelas, de manga larga y cuello redondo. Cuenta con lazo para ajustar en la cintura, con terminación de flecos.\n-Calce relajado\n-Color negro', 'Vestimenta', 22567, 1000, 'S', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Saona', 'Vestido corto con breteles que se sujetan al cuello y espalda al descubierto que contiene apertura lateral a través de cierre invisible.\n-Detalle de frunces.\n-Color amarillo', 'Vestimenta', 22678, 1600, 'M', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Moscú', 'Vestido de largo al tobillo y calce relajado, tiene elástico en el bajo busto que marca la silueta y mangas cortas y amplias, es súper cómodo y canchero.\n-Escote en V y cuadrado en espalda\n-Mangas amplias\n-Color fucsia', 'Vestimenta', 22789, 1400, 'L', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Drop', 'Vestido sin mangas, realizado en viscosa con efecto crinkle, lo que da un aspecto símil drapeado. Con escote en el frente, espalda descubierta y recorte en la cintura con costuras elásticas en la parte trasera.\n-Largo mini\n-Color Verde', 'Vestimenta', 22890, 1200, 'S', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Juliette', 'Vestido corto con breteles regulables y escote. Bordado de diseño calado en las tazas, frunces en la cintura y detalle de volados en la falda. Vestido ideal para civiles.\n-Volados en el ruedo y bordados cut-out en el frente\n-Color Crudo', 'Vestimenta', 22891, 400, 'S', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Zebra', 'Vestido corto confeccionado en viscosa, con breteles cruzados en la espalda. Bordado de cebra hecho de lentejuelas y mostacillas. Con forrería a tono. Acceso por cierre invisible lateral.\n-Escote en espalda\n-Color negro y dorado', 'Vestimenta', 22892, 1400, 'M', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Sol', 'Vestido largo (al tobillo), con breteles regulables que se cruzan en la espalda, confeccionado en gasa con bordado de mostacillas a tono que suman brillo.\n-Moldería relajada con recorte en la cintura\n-Largo al tobillo\n-Color amarillo', 'Vestimenta', 22893, 1400, 'S', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Mar', 'Vestido corto mini, confeccionado en microfibra alta torsión. Presenta detalle de buche en delantero.\n-Color azul', 'Vestimenta', 22894, 1300, 'M', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Tiras', 'Sandalias 100% confeccionadas en cuero vacuno. Taco piramidal de 6cm. Con elástico en tiras de empeine del lado interior.\n-Punta cuadrada\n-Color gold', 'Calzado', 26123, 1100, 'Tallle 36', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Trenza', 'Sandalias 100% confeccionadas en cuero vacuno. Taco de 7.5cm y plataforma de 3cm. Con dos tiras de cuero trenzadas. Súper livianas y cómodas!\n-Punta cuadrada redondeada\n-Color peltre', 'Calzado', 26234, 1100, 'Talle 37', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Ana', 'Sandalias 100% confeccionadas en cuero vacuno. Tira principal acolchada para mayor comodidad. Taco piramidal de 6cm que brinda estabilidad y seguridad al caminar.\n-Punta cuadrada\n-Color negro', 'Calzado', 26345, 1100, 'Talle 38', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Ana Plata', 'Sandalias 100% confeccionadas en cuero vacuno. Tira principal acolchada para mayor comodidad. Taco piramidal de 6cm que brinda estabilidad y seguridad al caminar.\n-Punta cuadrada\n-Color plata', 'Calzado', 26345, 1100, 'Talle 38', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Adele', 'Sandalia de gamuza, realizada 100% en cuero. Con un taco ideal de 4cms de alto. Súper cómodas para no sacárselas en toda la noche.\n-Taco de 4 cm.\n-Color negro', 'Calzado', 26567, 1100, 'Talle 35', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Bota Lea', 'Bota confeccionada 100% en cuero gamuzado combinado con recortes de croco y recorrido de remaches a tono. Con taco cuadrado de 7,5cm de altura. Perfectas para fiestas más relajadas\n-Bota caña baja\n-Cierre en talón\n-Color negro', 'Calzado', 26678, 1200, 'Talle 38', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Eme', 'Sandalia confeccionada 100% en cuero vacuno. Con una tira frontal. Con taco de 8cm y plataforma de 2cm. Combina absolutamente con todo y son ideales para bailiar toda la noche!\n-Color plata', 'Calzado', 26789, 1200, 'Talle 37', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Manuela', 'Toda de terciopelo hecha a mano, ideal para novias y para todas las fiestas! Taco de 7cm. Plantilla extra acolchonada para bailar toda la noche!\n-Color verde', 'Calzado', 26890, 1300, 'Talle 35', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sandalia Tana', 'Sandalias 100% confeccionadas en cuero vacuno. Altura ideal y comodidad máxima. Plantilla extra acolchonada para bailar toda la noche! Taco de 8cm y plataforma de 1,5cm\n-Color plata', 'Calzado', 26891, 400, 'Talle 39', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Bota Juana', 'Bota corta confeccionada 100% cuero vacuno. Taco perfecto de 6cm, calce perfecto, usala con vestidos y pantalones, esta bota va a elevar todos tus looks!\n-Color peltre', 'Categoria', 26892, 1400, 'Talle 35', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Collar Heart', 'Collar corto compuesto por una cadena de mostacillas y corazones en metal a tono. El cierre cuenta con cadenita para regular su extensión y un pequeño gancho metálico.\n-Ajuste regulable\n-Medidas 42 cm\n-Color verde metálico', 'Accesorios', 28345, 300, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Collar Fergus', 'Collar de múltiples cadenas de mostacillas negras unidas por un gran dije central con forma de flor en metal labrado con incrustaciones.\n-Medidas: 55 cm.\n-Color negro y dorado', 'Accesorios', 28456, 300, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Collar Flower ', 'Collar tipo choker, compuesto por cadenas con eslabones gruesos y chatos. El protagonista de esta pieza es su flor central en metal con diseño labrado y detalles en strass.\n-Medidas 35 cm.\n-Color plata', 'Accesorios', 28567, 400, 'Talle único', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Collar Cadena', 'Collar corto, compuesto por una cadena gruesa con eslabones de diseño en metal. Un accesorio súper canchero para fiestas descontracturadas o más formales.\n-Medidas 40 cm.\n-Color dorado', 'Accesorios', 28678, 200, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Pulsera Flower', 'Pulsera en metal, compuesto por cadenas con eslabones gruesos y chatos. Su detalle protagonista es la flor central en metal con textura y detalles en strass.\n-Medidas 13,5 cm.\n-Color plata', 'Accesorios', 28789, 400, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Cartera Nudo', 'Sobre/cartera con nudo en el frente, un divertido toque final para tus looks festivos. Se puede sostener mediante el nudo frontal o con la cadena desmontable. Composición 100% cuero.\n-Medidas: 25cm x 12cm\n-Color negro', 'Accesorios', 28890, 400, 'Talle único', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Cartera Flower', 'Sobre pequeño tipo billetera. Confeccionado en cuero, con apliques de flores bordadas en el frente y detalle de tachas en color dorado viejo. El interior cuenta con un tarjetero en uno de sus lados.\n-Medidas 16 cm. x 10 cm.\n-Color azul y dorado', 'Accesorios', 28891, 400, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Sobre Diamante', 'Sobre con correa extraíble, en cuero sintético con decoración de cristales y herrajes plateados y dorados. Cierre con broche imantado y bolsillo interior.\n-Longitud de la correa 15cm\n-Medidas: 30cm de ancho x 12cm de alto\n-Color plateado y dorado', 'Accesorios', 28892, 400, 'Talle único', 'No Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Cinto Flower', 'Cinturón realizado en piezas metálicas irregulares superpuestas con apliques en strass. Con tres medidas y un tramo elástico para adaptar el ajuste.\n-Medidas 80 cm.\n-Color plata', 'Accesorios', 28234, 200, 'Talle único', 'Disponible');
INSERT INTO products (name, description, category, code, price, size, status) VALUES ('Vestido Foil', 'Vestido escote en V, confeccionado en tejido elastizado con detalles de estampado foil que aportan brillo. Elástico en cintura y volados en la falda.\n-Largo hasta los tobillos\n-Mangas 3/4\n-Color plateado', 'Vestimenta', 22895, 1400, 'S', 'No Disponible');
