    ...
    return (
        <>
            ...
            <nav className="admin-menu">
                ...
                <a href="/administración/adminProducts">
                ...
                <a href="/administración/addProduct">
                    <button className="admin-panel-button">
                ...
                <a href="/administración/caracteristicas">
                    <button className="admin-panel-button">
                ...
                <a href="/administración/categories">
                    <button className="admin-panel-button">
                        <i className="ri-add-fill"></i>
